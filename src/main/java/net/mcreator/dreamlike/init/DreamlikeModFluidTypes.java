...
import net.mcreator.dreamlike.fluid.types.DreamwaternocolorFluidType;
...
public class DreamlikeModFluidTypes {
	...
	public static final RegistryObject<FluidType> DREAMWATERNOCOLOR_TYPE = REGISTRY.register("dreamwaternocolor", () -> new DreamwaternocolorFluidType());
}

package net.mcreator.dreamlike;
...
@Mod("dreamlike")
public class DreamlikeMod {
	public static final Logger LOGGER = LogManager.getLogger(DreamlikeMod.class);
	public static final String MODID = "dreamlike";

...
public class DreamwaterBlock extends LiquidBlock {
	public DreamwaterBlock() {
		super(() -> DreamlikeModFluids.DREAMWATER.get(), BlockBehaviour.Properties.of().mapColor(MapColor.WATER).strength(100f).hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true).lightLevel(s -> 6).noCollission()
